...
class RAdam(Optimizer):
    ...
    # Implementation from https://github.com/LiyuanLucasLiu/RAdam
...
class Optimizer:
    ...
    def get(self, params, **kwargs):
        return self.fun(params, **kwargs)


OPTIMIZERS = [
    Optimizer(name="sgd", fun=torch.optim.SGD),
    Optimizer(name="adam", fun=torch.optim.Adam),
    Optimizer(name="radam", fun=RAdam),
]
